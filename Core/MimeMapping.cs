...
namespace Woof.Core {
    ...
    public static class MimeMapping {
        ...
        private abstract class MimeMappingDictionaryBase {
            ...
            private static readonly char[] _pathSeparatorChars = new char[] { Path.DirectorySeparatorChar, Path.AltDirectorySeparatorChar, Path.VolumeSeparatorChar };
        ...
        private sealed class MimeMappingDictionary : MimeMappingDictionaryBase {
